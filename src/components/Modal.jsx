  ...
  return (
    <div className="bg-lightCyan bg-opacity-95 md:px-20 px-8 py-10 max-w-7xl rounded-md ">
      ...
      <p className="pt-3 text-darkCyan">
        ...
        elit. Ipsam autem repudiandae eveniet minus nobis mollitia facilis quas,
        earum, distinctio ut maiores quibusdam minima aperiam impedit quam
        dolor, reiciendis voluptas repellat. Lorem ipsum dolor sit amet,
        consectetur adipisicing elit. Ipsam autem repudiandae eveniet minus
        nobis mollitia facilis quas, earum, distinctio ut maiores quibusdam
        minima aperiam impedit quam dolor, reiciendis voluptas repellat.
      </p>
    </div>
  );
}
